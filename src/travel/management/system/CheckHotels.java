...
{   
    ...
    public void run()
    {
        String[] text = new String[]{"JW Marriot Hotel","Madarin Oriental Hotel","Four Season Hotel","Raddisson Blue Hotel","Classio Hotel","The Bay Club Hotel","Breeze Blow Hotel", "The Taj Hotel", "Happy Morning Hotel","River View Hotel"};
